...
const Home = () => {
    ...
    return (
        <div>
            <main className={`min-h-screen bg-black flex flex-col ${isRTL ? '' : mont.className}`} style={{ direction, textAlign }}>
                <div className="flex w-full justify-between">
                    <div className={`w-full sm:px-8 ps-32 py-40 flex items-center lg:px-6 md:px-6 md:py-12 bg-black`}>
                        ...
                        <div className={`flex w-1/2 sm:hidden md:hidden justify-end`}>
